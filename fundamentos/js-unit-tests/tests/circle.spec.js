...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Objeto retornado possui 3 propriedades.', () => {
    expect(Object.keys(circle(2)).length).toBe(3);
  });
  // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
  it('Retorna undefined caso não receba nenhum parâmetro.', () => {
    expect(circle()).toBeUndefined();
  });
  // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à 
  // circunferência correta para um círculo de raio 2.
  it('Retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2.', () => {
    expect(circle(2)).toHaveProperty('circumference', 12.56);
  });
  // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à 
  // área correta para um círculo de raio 3.
  it('Retorna uma `key` com `value` igual à área correta para um círculo de raio 3.', () => {
    const circleResult = circle(3);
    expect(circleResult.area).toBeCloseTo(28.26, 5);
  });
  // Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3.
  it('Retorna os dados corretos de um círculo de raio 3.', () => {
    const circleResult = circle(3);
    expect(circleResult.area).toBeCloseTo(28.26, 5);
    expect(circleResult.circumference).toBeCloseTo(18.84, 5);
    expect(circleResult.radius).toBe(3);
  });
});
