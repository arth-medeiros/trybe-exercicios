...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  // Teste se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou 
  //minúsculas retorna o mesmo objeto relativo a ele.
  it('Teste se o parâmetro não é Case Sensitive.', () => {
    const upper = getCharacter('Melissandre');
    const lower = getCharacter('melissandre');
    expect(upper).toStrictEqual(lower);
  });
  // Teste se ao passar um nome que não está na tabela, a função retorna undefined.
  it('Ao passar um nome que não está na tabela retorna undefined.', () => {
